...
**Capacitor v7 compatible fork** of the original [@kduma-autoid/capacitor-sunmi-printer](https://github.com/kduma-autoid/capacitor-sunmi-printer) by Krystian Duma.

## About this fork

This is a Capacitor v7 compatible version of the original Sunmi printer plugin. The original plugin was designed for Capacitor v6, but this fork has been updated to work with Capacitor v7+.

**Original repository:** [https://github.com/kduma-autoid/capacitor-sunmi-printer](https://github.com/kduma-autoid/capacitor-sunmi-printer)
...
```typescript
/// <reference types="@fivan0/capacitor-sunmi-printer" />
